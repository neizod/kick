...
return $('#boss').addClass(this.status);};return _Class;})());player=new((function(){function _Class(){this.lvl=1;this.lives=3;this.score=0;this.word=null;this.pair=null;this.longest=[];}
